...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_DEAR','Cześć');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_THANKYOU','dziękuję za rezerwację w ');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_ORDER','Numer rezerwacji');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_ARRIVAL','Rezerwacja od');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_DEPARTURE','Rezerwacja do');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_TOTALG','Liczba osób');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_TOTALP','łącznej cenie');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_DEPOSIT','Depozyt wymagany');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_BALANCE','Balance');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_SPECIAL','Special Requirements');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_VIEWBB','Szczegóły rezerwacji.');
...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_VIEWP','Informacje o hotelu');
...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_QUESTIONS','Jeżeli mają Państwa pytania dotyczące tej rezerwacji, prosimy się nie wahać i skontaktować się z nami');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_CONTACT','Nasz mail brzmi ');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_POLICIES','Regulamin');
...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_HELLO_CANCEL','pańska rezerwacja została anulowana : ');
...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_CONFIRMED','<strong>Rezerwacja potwierdzona</strong>. Data przybycia');
...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_ROOMS','Pokój');