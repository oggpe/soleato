...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_DEAR','Hello');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_THANKYOU','thank you for your booking at ');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_ORDER','Booking Number');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_ARRIVAL','Arrival Date');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_DEPARTURE','Departure Date');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_TOTALG','Total Guest(s)');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_TOTALP','Total Price');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_DEPOSIT','Deposit required');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_BALANCE','Rest payment');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_SPECIAL','Special Requirements');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_VIEWBB','View booking Details');
...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_VIEWP','View Property Details');
...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_QUESTIONS','Any questions, comments, concerns?');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_CONTACT','Contact us at ');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_POLICIES','Policies & Disclaimers');
...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_GUEST','Guest');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_PHONE','Phone(s)');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_EMAIL','E-mail');
jr_define('JPD_JOMRES_EMAILS_ENHANCER_ADDRESS','Address');
...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_HELLO_CANCEL','your booking has been cancelled : ');
...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_CONFIRMED','Your <strong>booking has been confirmed</strong> and the resource will be held until your arrival. We shall look forward to greeting you on');
...
jr_define('JPD_JOMRES_EMAILS_ENHANCER_ROOMS','Room');
