        ...
        if ($mrConfig[ 'showExtras' ] == '1') {
            ...
            foreach ($exList as $ex) {
                ...
                if (!$show_extra) {
                    ...
                    //$extra_deets[ 'MODELTEXT' ] = $tax_output.' ( '.$model_text.' )'; //OPE
					$extra_deets[ 'MODELTEXT' ] = $tax_output;
                    if ($model[ 'model' ] != '100') {
    ...
    */
    ...
    public function makeGuestData()
    {
        ...
        */
        ...
        //selected country is the countre extracted from the locale tag
        $guest_deets[ 'COUNTRY' ] = $this->bookingCountriesDropdown(substr(JFactory::getLanguage()->getTag(), -2));
