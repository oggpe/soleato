...
function get_property_price_for_display_in_lists($property_uid)
{
    ...
    if ($plugin_will_provide_lowest_price) {
        ...
        $tmpquery = 'SELECT property_uid,  min(roomrateperday) as roomrateperday FROM #__jomres_rates WHERE property_uid IN ('.$property_uid.") AND roomrateperday > 0 group by property_uid";
